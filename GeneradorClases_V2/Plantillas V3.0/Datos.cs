...
namespace <Namespace>
{
    public class <TableName>
    {
        ...
        public DataTable ConsultarPorPK(<PrimaryKeys> <FieldType> <FieldName>,
    </PrimaryKeys> )
        {
            SqlCommand command = new SqlCommand();
        ...
        public DataTable ConsultarVarios(String Filtro)
        {
            SqlCommand command = new SqlCommand();
            SqlDataAdapter da = new SqlDataAdapter();
            DataTable dt = new DataTable();
            try
            {
                ...
                if (command.Connection.State == ConnectionState.Closed)
                    command.Connection.Open();
                command.Parameters.Add("@sOperacion", SqlDbType.VarChar, 5).Value = "SV";
                command.Parameters.Add("@Filtro", SqlDbType.VarChar, 50).Value = Filtro;
